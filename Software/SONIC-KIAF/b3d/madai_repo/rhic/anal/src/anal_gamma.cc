...
void CAnalyze::CalcGamma(){
	...
	/*
	if(STAR_ACCEPTANCE)	
	  filename="results/"+qualifier+"_STAR.dat";
	  else filename="results/"+qualifier+".dat";*/
	filename=detailsdirname+"/gamma.dat";
	...
	for(ieta=0;ieta<NETA;ieta++){
	  printf("%4.2f | %10.3e %10.3e %10.3e %10.3e | %10.3e %10.3e %10.3e %10.3e\n",(0.5+ieta)*deleta,gss[ieta],gb[ieta],gssprime[ieta],gbprime[ieta], css[ieta],cb[ieta],cssprime[ieta],cbprime[ieta]);
