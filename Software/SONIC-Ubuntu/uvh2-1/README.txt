...
* The hadron afterburner (b3d from the MADAI collaboration)
is in a zipped-tar file named

b3d.tgz

Put it into a separate subdirectory of the hydro code and compile
the different modules with "make". Put the executeables "b3d" and
"analyze" in the the hydro directory.
